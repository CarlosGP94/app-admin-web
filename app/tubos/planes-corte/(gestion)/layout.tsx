...
const LayoutTitleContext = createContext<LayoutTitleContextType>({
  title: "Gestión de Planes de Corte",
  subtitle: "",
  setTitleInfo: () => {},
});
...
export const useLayoutTitle = () => {
  ...
  if (!context) {
    throw new Error(
      "useLayoutTitle debe ser utilizado dentro de un GestionPlanesCorteLayout",
    );
  }
  return context;
};

export default function GestionPlanesCorteLayout({
  children,
}: {
